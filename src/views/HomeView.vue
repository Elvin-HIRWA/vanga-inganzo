<template>
  <div>
    ...
    <!----Main Wrapper Start---->
    <div class="ms_main_wrapper" style="background-color: white">
      <!---Side Menu Start--->
              ...
              <div class="col-lg-12 col-md-12">
                ...
                <div class="ms_banner_text">
                  ...
                  <p>
                    ...
                    Dark Alley, One More Of A Stranger, Endless<br />
                    Things, The Heartbeat Stops, Walking Promises, Desired Games
                    and many more...
                  </p>
                </div>
              </div>
        ...
        <div class="ms_advr_wrapper ms_advr2">
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                <a href="#"
                  ><img src="images/adv1.jpg" alt="" class="img-fluid"
                /></a>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="footer_box footer_app">
                ...
                <a href="#" class="foo_app_btn"
                  ><img src="images/google_play.jpg" alt="" class="img-fluid"
                /></a>
                <a href="#" class="foo_app_btn"
                  ><img src="images/app_store.jpg" alt="" class="img-fluid"
                /></a>
                <a href="#" class="foo_app_btn"
                  ><img src="images/windows.jpg" alt="" class="img-fluid"
                /></a>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
